				...
				React.createElement("form", {role: "form"}, 
					...
					React.createElement("div", {className: "row"}, 
						React.createElement("div", {className: "col-lg-6"}, 
							...
							React.createElement(Input, {name: "city", label: "Address Line2"}), 
							React.createElement(Input, {name: "state", label: "Address Line2"}), 
							React.createElement(Input, {name: "dob", label: "Address Line2"})
						)	
					)					
				)
